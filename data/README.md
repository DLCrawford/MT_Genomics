...
| Analysis-ready variant call set | Zenodo *(DOI TBD)* | `141_MT_variants.vcf.gz` (+ index): 141 samples × 927 coding variants, per-cell GT/DP/AD + SnpEff `ANN` |
| Sample metadata | Zenodo *(DOI TBD)* | individual ID → population (DC/PA/TR) → clade (N/S) → plate/well |
